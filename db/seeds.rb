...
ActiveRecord::Base.transaction do
  ...
  Like.destroy_all
    ...
    l59 = Like.create!(user_id: chuck.id, post_id: p1.id)
    # l60 = Like.create!(user_id: chuck.id, post_id: p2.id)
    # l61 = Like.create!(user_id: chuck.id, post_id: p3.id)
    # l62 = Like.create!(user_id: chuck.id, post_id: p4.id)
    # l63 = Like.create!(user_id: chuck.id, post_id: p5.id)
    # l64 = Like.create!(user_id: chuck.id, post_id: p6.id)
    # l65 = Like.create!(user_id: chuck.id, post_id: p7.id)
    # l66 = Like.create!(user_id: chuck.id, post_id: p8.id)
    # l67 = Like.create!(user_id: chuck.id, post_id: p9.id)
    # l68 = Like.create!(user_id: chuck.id, post_id: p10.id)
    # l69 = Like.create!(user_id: chuck.id, post_id: p11.id)
    # l70 = Like.create!(user_id: chuck.id, post_id: p12.id)
    # l71 = Like.create!(user_id: chuck.id, post_id: p13.id)
    # l72 = Like.create!(user_id: chuck.id, post_id: p14.id)
    # l73 = Like.create!(user_id: chuck.id, post_id: p15.id)
    # l74 = Like.create!(user_id: chuck.id, post_id: p16.id)
    # l75 = Like.create!(user_id: chuck.id, post_id: p17.id)
    # l76 = Like.create!(user_id: chuck.id, post_id: p18.id)
    # l77 = Like.create!(user_id: chuck.id, post_id: p19.id)
